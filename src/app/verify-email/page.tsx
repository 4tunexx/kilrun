...
export default function VerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    getSessionUser().then((user) => {
      setStep(user?.emailVerified ? 'already-verified' : 'email');
    });
  }, [sessionStatus, steamId]);
        ...
        <div className="rounded-2xl border border-primary/30 bg-slate-900/70 backdrop-blur-xl shadow-[0_0_40px_rgba(239,68,68,0.25)] p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Secure your player profile</p>
            </div>
          </div>
          ...
          {step === 'already-verified' && (
            <div className="text-center py-8 space-y-4">
              ...
              <p className="text-slate-200 font-semibold">Your email is already verified.</p>
          ...
          {step === 'email' && (
            <form onSubmit={handleSendCode} className="space-y-5">
              ...
              <Button type="submit" disabled={!isLoaded || isSubmitting} className="w-full shadow-[0_0_20px_rgba(239,68,68,0.35)]">
                {isSubmitting ? (
              ...
              {/* Clerk requires an element with this id to satisfy bot-protection challenges during signUp.create(). */}
          ...
          {step === 'code' && (
            <form onSubmit={handleVerifyCode} className="space-y-5">
              ...
              {error && <p className="text-sm text-destructive">{error}</p>}
              <Button type="submit" disabled={isSubmitting || code.length < 6} className="w-full shadow-[0_0_20px_rgba(239,68,68,0.35)]">
          ...
          {step === 'success' && (
            <div className="text-center py-6 space-y-4">
              <div className="w-20 h-20 mx-auto rounded-full bg-primary/20 border-2 border-primary flex items-center justify-center shadow-[0_0_40px_rgba(239,68,68,0.5)] animate-pulse">
                <Sparkles className="w-10 h-10 text-primary" />
              </div>
              <h2 className="text-xl font-black text-white">Profile Unlocked!</h2>
              <p className="text-slate-300">
