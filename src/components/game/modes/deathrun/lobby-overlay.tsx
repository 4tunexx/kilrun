...
export const LobbyOverlay: React.FC<{
  playerCount: number;
  isAdmin?: boolean;
  onForceStart?: () => void;
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-slate-950/60 backdrop-blur-sm z-[130]">
      <div className="bg-slate-900/90 border border-slate-700 rounded-3xl p-8 sm:p-10 flex flex-col items-center gap-4 shadow-2xl mx-4 max-w-md w-full">
